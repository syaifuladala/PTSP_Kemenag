<html>
    ...
    <body>
        ...
        <center>
        <img class="icon_home" src="<?php echo base_url('assets/gambar/ods/ods16b.png')?>">
        <h1>PELAYANAN PERMOHONAN ROHANIWAN</h1>
        </center>
        
        <div class="info">     
        <h2>Persyaratan</h2>
        <ol class="list">
            <li>Membawa surat resmi dari instansi atau institusi yang mengajukan permohonan rokhaniwan.</li>
        </ol>
        <h2>Estimasi Waktu Pelayanan</h2>
        <a class="list">30 Menit bagi nama-nama yang sudah ada.</a>
        </div>
