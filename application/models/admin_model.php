...
class admin_model extends CI_Model{
    ...
    public function load_all_data() {
       return $this->db->query('select p.id_pengajuan , u.nama , l.nama_layanan , p.status, p.tgl_pengajuan '
                . 'FROM pengajuan p '
                . 'INNER JOIN daftar_layanan l ON l.id = p.id_layanan '
                . 'INNER JOIN user u ON u.nik = p.nik ')->result('array');
      
    }
    
    public function load_new_data() {
       return $this->db->query('select '
               ...
               . 'FROM pengajuan p '
               . 'INNER JOIN daftar_layanan l ON l.id = p.id_layanan '
               . 'INNER JOIN user u ON u.nik = p.nik '
               . 'WHERE p.status = "pending" '
               . 'ORDER BY p.tgl_pengajuan ASC')->result('array');
    }
    
    public function get_detail_pengajuan_ods3($id_pengajuan) {
