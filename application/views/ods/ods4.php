<html>
    <head>
        <title>PENGAJUAN IJIN MAGANG</title>
    ...
    <body>
        ...
        <center>
        <img class="icon_home" src="<?php echo base_url('assets/gambar/ods/ods4.png')?>">
        <h1>PENGAJUAN IJIN MAGANG</h1>
        </center>
        
        <div class="info">    
        <h2>Persyaratan : </h2>
        <ol class="list">
            <li>Membawa surat permohonan resmi dari institusi yang bersangkutan</li>
            <li>Foto copy Kartu Mahasiswa (identitas)</li>
        </ol>
        ...
        <ol class="list">
            ...
            <a href="<?php echo base_url('index.php/Home_controler/layananODS')?>">
                <button class="btn btn-primary mybutton btn-lg">Kembali</button></a>
