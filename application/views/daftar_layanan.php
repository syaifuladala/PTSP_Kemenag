<html>
    ...
    <body style="background-image: url(<?php echo base_url('assets/gambar/bg.jpg') ?>)">
        ...
        <center><h1> Pilih Jenis Layanan </h1></center>    
        
        <div class="mymenu" style="margin-left: 230px">
            <a href="<?php echo base_url('index.php/Home_controler/layananODS')?>"><img class="icon_home" src="<?php echo base_url('assets/gambar/ods/ods_icon.png')?>"></a>
            ODS (One Day Service)
           </div>
            
        <div class="mymenu" style="margin-left: 180px">
           <a href="<?php echo base_url('index.php/Home_controler/layananNODS')?>"><img class="icon_home" src="<?php echo base_url('assets/gambar/nods/nods_icon.png')?>"></a>
             Non ODS (One Day Service)
          </div>
       </div>
