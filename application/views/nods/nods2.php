<html>
    ...
    <body>
        ...
        <center>
        <img class="icon_home" src="<?php echo base_url('assets/gambar/nods/nods2.png')?>">
        ...
        <h2>Persyaratan</h2>
        <ol class="list">
            <li>Membawa surat resmi dari instansi atau institusi yang mengajukan permohonan audensi</li>
        </ol>
        <h2>Estimasi Waktu Pelayanan</h2>
        <ol class="list">
            <li>15 menit (dari pemohon menyerahkan permohonan sampai mendapat informasi jadwal rutin pelaksanaan audiensi serta kepastian jadwal dalam waktu 3 hari)</li>
