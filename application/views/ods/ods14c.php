<html>
    <head>
         <title>LEGALISIR DOKUMEN KEPEGAWAIAN</title>
    ...
    <body>
        ...
        <center>
        <img class="icon_home" src="<?php echo base_url('assets/gambar/ods/ods14c.png')?>">
        <h1>LEGALISIR DOKUMEN KEPEGAWAIAN</h1>
        </center>
        
        <div class="info">    
        <h2>Persyaratan</h2>
        <ol class="list">
            <li>Membawa dokumen asli (kecuali SK)</li>
            <li>Membawa fotokopi dokumen</li>
        </ol>
    </body>
