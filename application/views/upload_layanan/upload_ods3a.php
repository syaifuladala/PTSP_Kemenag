...
<head>
    ...
    <title>Pengajuan Izin Penelitian Madrasah</title>
        ...
        <div id="pay-invoice">
          <div class="card-body">
            <div class="card-title">
                ...
                <?php //echo $file.$error;?>
                <?php echo form_open_multipart('Form_controller/upload_ods3a'); ?>
<!--                <form action="<?php// echo base_url('index.php/Form_controller/upload_ods3a'); ?>" method="post">-->
                    <center>
                        <?php foreach ($data as $key => $value) { ?>
                            ...
                            <input type="hidden" name="id_layanan" value="ods3a">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>Tujuan Madrasah Penelitian</td>
                                    <td><input type="text" name="tujuan" class="form-control" required></td>
                                </tr>
                                <tr>
                ...
                <div class="row m-0">
                    <div class="col-sm-12">
                        ...
                        <div class="page-title">
                            <center><h1>Input Berkas</h1></center>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo base_url('index.php/Form_controller/upload_ods3a'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <center>
                                    <?php foreach ($data as $key => $value) { ?>
                                    <input type="hidden" name="id_pengajuan" value="<?php echo $result;?>">
                                    <input type="hidden" name="id_layanan" value="ods3a">
                                    ...
                                    <input type="hidden" name="status" value="pending">
                                    <input type="hidden" name="komentar" value=" ">
                                    <input type="hidden" name="hasil" value=" ">
                                    <table class="table">
                                        <tr>
                                            <td>Nama Lengkap</td>
                                            <td><input type="text" name="nama" value="<?php echo $value['nama'] ?>" class="form-control" required></td>
                                       ...
                                       <tr>
                                            <td>Surat permohonan ijin penelitian/observasi dari lembaga resmi.</td>
                                            <td><?php //echo form_open_multipart('Form_controller/do_upload');?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="file-input" name="fc_identitas" class="form-control-file" >
