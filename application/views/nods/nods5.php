<html>
    <head>
        <title>PERMOHONAN SURAT KETERANGAN PENYELENGGARA IBADAH HAJI KHUSUS</title>
    ...
    <body>
        ...
        <center>
            <img class="icon_home" src="<?php echo base_url('assets/gambar/nods/nods5.png')?>" style="margin-top: 90px">
        <h1>PERMOHONAN SURAT KETERANGAN PENYELENGGARA IBADAH HAJI KHUSUS (PIHK)</h1>
