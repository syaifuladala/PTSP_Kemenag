<html>
    <head>
        <title>Konsultasi Keagamaan dan Non Keagamaan</title>
    ...
    <body>
        ...
        <center>
        <img class="icon_home" src="<?php echo base_url('assets/gambar/ods/ods15.png')?>"  style="margin-top: 90px">
        <h1>Konsultasi Keagamaan dan Non Keagamaan</h1>
        <h2>Pilih Konsultasi</h2>
        </center>
