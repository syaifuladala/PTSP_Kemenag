<html>
    <head>
        <title>PERMOHONAN REKOMENDASI PENYELENGGARA PERJALANAN IBADAH UMRAH (PPIU)</title>
    ...
    <body>
        ...
        <center>
            <img class="icon_home" src="<?php echo base_url('assets/gambar/nods/nods4.png')?>" style="margin-top: 90px">
        <h1>PERMOHONAN REKOMENDASI PENYELENGGARA PERJALANAN IBADAH UMRAH (PPIU)</h1>
